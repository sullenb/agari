 ...
 * @returns {any}
 */
export function calculate_shanten_js(hand) {
    const ptr0 = passStringToWasm0(hand, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_shanten_js(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function score_hand(request_js) {
    const ret = wasm.score_hand(request_js);
    return ret;
}
 ...
 * @returns {any}
 */
export function validate_hand(hand) {
    const ptr0 = passStringToWasm0(hand, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_hand(ptr0, len0);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('agari_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
